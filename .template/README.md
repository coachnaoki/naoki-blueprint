...
全 20 ステップを `/step01-context` 〜 `/step20-render` のスラッシュコマンドで順番に進めるだけで動画が完成します。
...
```bash
# 撮影した動画を public/video/ に配置
cp /path/to/your-video.mp4 public/video/
